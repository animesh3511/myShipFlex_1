...
public class StripePaymentController {
    ...
    public String deleteCustomer(@PathVariable String customerId, Model model) throws StripeException {
        Stripe.apiKey = stripeKey;
        Customer customer = Customer.retrieve(customerId);
    ...
    public String detachCard(@PathVariable String customerId, @PathVariable String cardLast4, Model model) throws StripeException {
        Stripe.apiKey = stripeKey;
        Customer customer = Customer.retrieve(customerId);
        List<PaymentMethod> paymentMethods = PaymentMethod.list(
                PaymentMethodListParams.builder()
        ...
        for (PaymentMethod paymentMethod : paymentMethods) {
            if (paymentMethod.getCard().getLast4().equals(cardLast4)) {
                ...
                CardData cardData = cardDataRepository.findByLast4AndCustomerId(cardLast4, customerId);
